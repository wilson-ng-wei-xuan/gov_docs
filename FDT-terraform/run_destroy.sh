...
################################################################################
# export TF_TOKEN_sgts_gitlab__dedicated_com="qeq7wxwDqh4kGhxFsx3x"
# export AWS_ACCESS_KEY_ID="AKIA36QSPB7XLOLFLMEW"
# export AWS_SECRET_ACCESS_KEY="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"
################################################################################
...
echo '[INFO] Starting Destroying Script...'
...
echo
echo '[INFO] Destroying remaining Terraform'
...
read -p "[INPUT] Enter [DESTROY] to remove terraform folders? : " destroy
if [[ $destroy == "DESTROY" ]]
then

...
class FlanGenerationModel(DynamodbModel):
    ...
    def put_generation_response(self, response_id, prompt, model, temperature, response, caller):
        """
        Store Flan prompt/model/response and additional params into DynamoDB
        """
        if not response_id:
...
if __name__ == "__main__":
    ...
    model = FlanGenerationModel(dynamodb, TABLE_MOONSHOT_LLM)

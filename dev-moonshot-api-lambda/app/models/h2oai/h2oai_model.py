...
class H2OAiGenerationModel(DynamodbModel):
    ...
    def put_generation_response(self, response_id, prompt, model, temperature, response, caller):
        """
        Store H2OAi prompt/model/response and additional params into DynamoDB
        """
        if not response_id:
...
if __name__ == "__main__":
    ...
    model = H2OAiGenerationModel(dynamodb, TABLE_MOONSHOT_LLM)

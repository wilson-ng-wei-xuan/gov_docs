...
class BloomGenerationModel(DynamodbModel):
    ...
    def put_generation_response(self, response_id, prompt, model, temperature, response, caller):
        """
        Store Bloom prompt/model/response and additional params into DynamoDB
        """
        if not response_id:
...
if __name__ == "__main__":
    ...
    model = BloomGenerationModel(dynamodb, TABLE_MOONSHOT_LLM)

...
subnets = [
  ...
  },
  {
    ...
    cidr_blocks        = ["172.30.254.64/27", "172.30.254.96/27"]
    share_route_table  = true
    assign_public_ipv4 = false
  },
  {
    ...
    cidr_blocks        = ["172.30.254.224/28", "172.30.254.240/28"]
    share_route_table  = true
    assign_public_ipv4 = false
  }
]
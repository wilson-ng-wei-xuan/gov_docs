...
def create_secret(secrets_client, arn, token):
  ...
  try:
    ...
    AccessKeyId = new_secret['SMTP_USER']
    ...
    new_secret['SMTP_FROM'] = new_secret['SMTP_FROM']
    new_secret['SMTP_PASSWORD'] = calculate_key( response['AccessKey']['SecretAccessKey'], 'ap-southeast-1' )
    new_secret['SMTP_USER'] = response['AccessKey']['AccessKeyId']

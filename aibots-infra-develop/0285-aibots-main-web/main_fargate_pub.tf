module "project_pub" {
  ...
  container_definitions    = [ {
    ...
    environment = [
      ...
      { name = "PROJECT_MAIN_API__PTE_URL", value = local.AIBOTS_MAIN_API__PTE_URL },
      { name = "PROJECT_MAIN_API__PUB_URL", value = local.AIBOTS_MAIN_API__PUB_URL },
      ...
      # { name = "PROJECT_OPENSEARCH__NAME",value = local.VECTORDB_OPENSEARCH__NAME },

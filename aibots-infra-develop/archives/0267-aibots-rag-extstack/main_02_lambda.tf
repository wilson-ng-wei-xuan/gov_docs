...
data "template_file" "env_var" {
  ...
  vars        = { # these are the variables to render
    ...
    # # STATUS use by ALL
    ############################################################################
    PROJECT_RAG_STATUS_GOVTEXT__SQS       = local.AIBOTS_RAG_STATUS_GOVTEXT__SQS
    ############################################################################
...
data "template_file" "policy" {
  ...
  vars        = { # these are the variables to render
    ...
    # # STATUS use by ALL
    ############################################################################
    PROJECT_RAG_STATUS_GOVTEXT__SQS_ARN       = data.aws_sqs_queue.aibots_rag-status_govtext.arn
    ############################################################################
    # # STORE use by EMBED
    ############################################################################

...
subnets = [
  ...
  },
  {
    ...
    cidr_blocks = ["172.30.250.128/28","172.30.250.144/28"]
    share_route_table = true
    assign_public_ipv4 = false
  },
  {
    ...
    cidr_blocks = ["172.30.250.224/28", "172.30.250.240/28"]
    share_route_table = true
    assign_public_ipv4 = false
  }
]
...
subnets = [
  {
    ...
    cidr_blocks        = ["100.127.128.0/28", "100.127.128.16/28"]
  ...
  },
  {
    ...
    cidr_blocks        = ["100.127.128.32/28", "100.127.128.48/28"]
    share_route_table  = true
    assign_public_ipv4 = false
  },
  {
    ...
    cidr_blocks        = ["100.127.128.64/28", "100.127.128.80/28"]
    share_route_table  = true
    assign_public_ipv4 = false
  },
  {
    ...
    cidr_blocks        = ["100.127.128.96/28", "100.127.128.112/28"]
    share_route_table  = true
    assign_public_ipv4 = false
  },
  {
    ...
    cidr_blocks        = ["100.127.128.128/28", "100.127.128.144/28"]
    share_route_table  = true
    assign_public_ipv4 = false
  },

  {
    ...
    cidr_blocks        = ["100.127.128.192/27", "100.127.128.224/27"]
    share_route_table  = true
    assign_public_ipv4 = false
  },
]
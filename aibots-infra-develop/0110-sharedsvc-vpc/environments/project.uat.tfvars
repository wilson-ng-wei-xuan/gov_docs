...
subnets = [
  ...
  },
  {
    ...
    cidr_blocks        = ["172.30.253.128/28", "172.30.253.144/28"]
    share_route_table  = true
    assign_public_ipv4 = false
  },
  {
    ...
    cidr_blocks        = ["172.30.253.224/28", "172.30.253.240/28"]
    share_route_table  = true
    assign_public_ipv4 = false
  }
]
...
docker login -u AIBotsDevOps -p  {ATLAS_TOKEN} registry.sgts.gitlab-dedicated.com/wog/gvt/dsaid-st/atlas/python/
...
## aibots-api deployment steps
Refer to deployment section in aibots-api README.MD

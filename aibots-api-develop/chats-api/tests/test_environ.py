...
def mock_environ():
    ...
    os.environ["PROJECT_REDIS__PARAM"] = "param-sitezdb-aibots-api-redis"
    ...
    os.environ["PORT"] = "443"
    os.environ["CLOAK__PARAM"] = "param-sitez-aibots-cloak"
...
class TestAIBotsChatEnviron:
    def test_aibots_chat_environ_loading_default_env_vars(
    ...
    def test_aibots_chat_environ_loading_infra_aligned_env_vars(
        ...
        assert environ.model_dump() == {
            ...
            "cloak": {
                "auth": None,
                "bucket": None,
                "param": "param-sitez-aibots-cloak",
                "path": None,
                "pub_url": None,
                "secret": None,
                "url": None

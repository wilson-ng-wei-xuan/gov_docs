...
def app_environ():
    return {
        ...
        'GOVTEXT__PARAM': 'param-sitez-aibots-govtext',
        'USE_SSL': '1',
        ...
        'AGENTS_TAG': os.environ.get('AGENTS_TAG', 'latest'),
        'NOUS_TAG': os.environ.get('NOUS_TAG', 'develop'),
        'MAIN_TAG': os.environ.get('MAIN_TAG', 'latest'),
        'MOONSHOT_REGISTRY': os.environ['MOONSHOT_REGISTRY'],

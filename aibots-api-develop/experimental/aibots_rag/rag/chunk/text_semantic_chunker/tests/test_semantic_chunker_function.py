...
class TestSemanticChunkerFunc:
    ...
    def test_semantic_chunker_results(self, request, parsed, source_result_key) -> None:
        """tests lambda function output"""
        semantic_chunk_config: Dict[str, Any] = request.getfixturevalue("semantic_chunk_config")

...
from ..lambda_function import FixedChunker
...
class TestFixedChunker:
    ...
    def test_fixed_chunker_next_success(self, request, parsed, source_result_key) -> None:
        """tests lambda function output"""
        mock_aws_infra: boto3.Session = request.getfixturevalue("mock_aws_infra")
        dataframe_chunk_config: Dict[str, Any] = request.getfixturevalue("fixed_chunk_config")
        ...
        chunker = FixedChunker(message, sqs, environ)
